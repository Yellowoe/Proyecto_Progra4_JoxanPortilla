...
async function getById(id){
    const response = await fetchWrapper.get(`${baseUrl}/find?id=${id}`);
    console.log('Fetching user by ID URL:', `${baseUrl}/find?id=${id}`);
    console.log('Response from API:', response);
    return response; // Asegúrate de que accedes a la respuesta correctamente
}
